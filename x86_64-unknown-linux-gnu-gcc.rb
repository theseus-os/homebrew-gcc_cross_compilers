...
class X8664UnknownLinuxGnuGcc < Formula
  ...
  depends_on "mpfr"
  depends_on "isl"
  depends_on 'x86_64-unknown-linux-gnu-binutils'

  def install
    binutils = Formulary.factory 'x86_64-unknown-linux-gnu-binutils'
    ...
    mkdir 'build' do
      ...
      FileUtils.ln_sf binutils.prefix/"x86_64-unknown-linux-gnu", prefix/"x86_64-unknown-linux-gnu"
